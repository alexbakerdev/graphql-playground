...
var GraphQLBinApp = /** @class */ (function (_super) {
    ...
    GraphQLBinApp.prototype.render = function () {
        ...
        {this.state.loading ? null : !this.state.endpoint ||
          ...
          </styled_1.ThemeProvider>) : (<PlaygroundWrapper_1.default endpoint={endpoint} headers={this.state.headers} isDemoMode={true} subscriptionEndpoint={subscriptionEndpoint}/>)}
      </Wrapper>);
    };
