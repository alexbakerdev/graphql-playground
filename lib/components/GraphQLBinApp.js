...
var GraphQLBinApp = /** @class */function (_super) {
    ...
    GraphQLBinApp.prototype.render = function () {
        ...
        return React.createElement(
            ...
            ) : React.createElement(PlaygroundWrapper_1.default, { endpoint: endpoint, headers: this.state.headers, isDemoMode: true, subscriptionEndpoint: subscriptionEndpoint })
        );
    };
