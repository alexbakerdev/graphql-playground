...
var Playground = /** @class */function (_super) {
    ...
    Playground.prototype.render = function () {
        ...
        return React.createElement(
            ...
            !this.props.isDemoMode && React.createElement(TabBar_1.default, { onNewSession: this.createSession, isApp: this.props.isApp }),
            React.createElement(
                GraphiqlsContainer,
                null,
                React.createElement(
            ...
            !this.props.isDemoMode && React.createElement(Settings_1.default, null),
...
var mapStateToProps = reselect_1.createStructuredSelector({
    ...
    isDemoMode: selectors_2.getIsDemoMode,
